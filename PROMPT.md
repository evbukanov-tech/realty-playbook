...
- Ограничение: 1 пользователь = 1 лайк на документ (повторное нажатие снимает лайк — toggle).
...
- Ошибки: если не авторизован — показать понятное сообщение/редирект на вход; если документ приватный/не найден — 404/ошибка; если БД недоступна — “Попробуйте позже”.
...
2) Серверная логика:
   ...
   - Проверь: документ существует и isPublic=true.
   - Toggle:
